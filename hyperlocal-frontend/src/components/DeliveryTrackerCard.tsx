...
export function DeliveryTrackerCard() {
  // Fake coordinates in a simple SVG map
      ...
      <div className="px-5 pb-5">
        <div className="rounded-2xl bg-brand-50 border border-brand-100 overflow-hidden">
          <svg viewBox="0 0 360 180" className="w-full h-44">
            {/* fake roads */}
            <path d="M20 150 C 80 120, 120 40, 170 70 S 260 160, 340 95" fill="none" stroke="#0F172A" strokeOpacity="0.12" strokeWidth="14" strokeLinecap="round" />
            <path d="M20 150 C 80 120, 120 40, 170 70 S 260 160, 340 95" fill="none" stroke="#16A34A" strokeOpacity="0.25" strokeWidth="6" strokeLinecap="round" />
